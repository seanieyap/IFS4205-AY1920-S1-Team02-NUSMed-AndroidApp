...
public class TherapistNormalUploadActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_therapist_normal_upload);
    ...
    public void onItemSelected(AdapterView<?> arg0, View arg1, int position, long id) {
        ...
        if (recordType != null) {
            ...
            EditText contentInput = (EditText) findViewById(R.id.therapistUploadContentField);
